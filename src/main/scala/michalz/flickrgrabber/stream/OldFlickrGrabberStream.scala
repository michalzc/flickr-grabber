...
/**
  ...
  */
object OldFlickrGrabberStream extends FlickrApiXmlSupport with LazyLogging {
  val slugify = new Slugify()

  def apply(fgConfig: FlickrGrabberConfig, nrOfImages: Int)(implicit system: ActorSystem, materializer: Materializer) = {

    implicit val executionContext = system.dispatcher
    implicit val apiKey = fgConfig.apiKey
